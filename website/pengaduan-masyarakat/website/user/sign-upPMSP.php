<html translate="off" <?php require '../.app/manifest/_manifest_.php'; ?>>
    <head>
        <?php
            ...
            if($_SERVER['REQUEST_METHOD'] == "POST") {
                ...
                mysqli_query($db, "INSERT INTO masyarakat VALUES('$nik','$nama','$username','$password','$telp')");
    ...
    <body>    
        <center>
            <div class="pmsp">
                <div class="form">
                    <h1 class="form-text1">PENGADUAN MASYARAKAT</h1>
                    <p class="form-text2">Daftar</p>
                    <form method="post" enctype="multipart/form-data">

                        <div class="form-input">
                            <input class="form-input-action" type="number" name="nik" placeholder="NIK" autocomplete="off" autofocus required/>
                        </div>

                        <div class="form-input">
                            <input class="form-input-action" type="text" name="nama" placeholder="Nama Lengkap" autocomplete="off" autofocus required/>
                        </div>
