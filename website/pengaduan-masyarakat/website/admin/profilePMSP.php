                ...
                <div class="a-frame">
                    <div class="a-frame-profile">
                        ...
                        <div class="a-frame-profile-detail">
                            <p class="a-frame-profile-detail-text1">ID :</p>
                            <p class="a-frame-profile-detail-text2"><?= $crypt->owl192_decode($_SESSION['id_petugas']); ?></p>
                        </div>
                        <div class="a-frame-profile-detail">
                            <p class="a-frame-profile-detail-text1">Nama Lengkap :</p>
                            <p class="a-frame-profile-detail-text2"><?= $crypt->owl128_decode($_SESSION['nama_petugas']); ?></p>
                        </div>
                        <div class="a-frame-profile-detail">
                        ...
                        <div class="a-frame-profile-detail">
                            <p class="a-frame-profile-detail-text1">Level :</p>
                            <p class="a-frame-profile-detail-text2"><?= $crypt->owl192_decode($_SESSION['level']); ?></p>
                        </div>
