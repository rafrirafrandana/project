<html translate="off" <?php require '../.app/manifest/_manifest_.php'; ?>>
    <head>
        <?php
            ...
            $data = mysqli_query($db, "SELECT * FROM pengaduan WHERE nik='$nik'");
    ...
    <body>    
        <center>
            <div class="pmsp">
                ...
                <div class="a-frame">
                    <button class="a-frame-button" onclick="window.location = 'add-complaint';">Ajukan</button>
                    <table style="background-color: #fff; box-shadow: 10px 15px 0px #222; width: 100%; border: 1px solid #222; border-radius: 10px;">
                        ...
                        <tr>
                            ...
                            <td style="color: #222; font-family: monospace; font-size: 15px; width: 100%; border-bottom: 1px solid #222; border-radius: 10px; padding: 10px;"><?= $status; ?></td>
                        </tr>
                        <?php
