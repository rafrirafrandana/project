    ...
    <head>
        <?php
            ...
            if($_SERVER['REQUEST_METHOD'] == "POST") {
                ...
                mysqli_query($db, "UPDATE masyarakat SET username='$username', password='$password' WHERE nik='$nik_get'");
                ...
                <div class="a-frame">
                    <div class="a-frame-form">
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="a-frame-form-input">
                                <input class="a-frame-form-input-action" type="passsword" name="password" placeholder="Password" value="<?= $password; ?>" autofocus autocomplete="off">    
                            </div>
