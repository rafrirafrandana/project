    ...
    <head>
        <?php
            ...
            if($_SERVER['REQUEST_METHOD'] == "POST") {
                ...
                mysqli_query($db, "UPDATE petugas SET username='$username', password='$password' WHERE id_petugas='$id_petugas_get'");
                            ...
                            <?php
                                ...
                                if( mysqli_num_rows($data) ) {
                                    while($row = mysqli_fetch_assoc($data) ) {
                                        ...
                                        $username = $crypt->owl256_decode($row['username']);
                                        $password = $crypt->owl256_decode($row['password']);

                            ?>

                            <div class="a-frame-form-input">
                                <input class="a-frame-form-input-action" type="text" name="username" placeholder="Username" value="<?= $username; ?>" autofocus autocomplete="off">    
                            </div>

                            <div class="a-frame-form-input">
                                <input class="a-frame-form-input-action" type="password" name="password" placeholder="Password" value="<?= $password; ?>" autofocus autocomplete="off">    
                            </div>
